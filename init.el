...
(doom! :input
       ...
       ;; (ligatures +fira)         ; ligatures and symbols to make your code pretty again ;; supports for pgtk not that good
       ...
       (org +dragndrop +pretty +pandoc +hugo)               ; organize your plain life in plain text
